...
export default function (name: String, options: BrowserWindowConstructorOptions = {}) {
    ...
    var resetToDefaults = function (windowState: any) {
    ...
    var ensureVisibleOnSomeDisplay = function (windowState: any) {
